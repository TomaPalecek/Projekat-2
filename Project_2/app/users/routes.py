...
@admin_router.put("/update-admin-by-id", response_model=AdminSchema)
def update_admin(
    admin_id: str,
    name: str = None,
    last_name: str = None,
